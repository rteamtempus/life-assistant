...
const SYSTEM = [
  ...
  '',
  'Time: if the dump states a time ("took meds at 9", "woke at 6:30"), set',
  'occurred_at to a full ISO-8601 timestamp resolved against the provided "now".',
  'If no time is given, set occurred_at to null.',
  '',
