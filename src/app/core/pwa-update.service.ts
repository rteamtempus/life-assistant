...
/**
 * "A new version is ready — reload?" (a PWA quality-of-life staple). Watches the
 * service worker for a freshly downloaded version, flips `updateReady`, and the
 * App shell shows a calm banner. `reload()` activates the new version and
 * refreshes.
 *
